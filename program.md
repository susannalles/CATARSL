...
The workshop will be highly hands-on and people are expected to bring their laptops on which they can install new software. Installation instructions for the software will be sent out to the participants in the weeks before the event. All data will be distributed on-site. <br/> <a href="../workshop1/instructions/">INSTRUCTIONS BEFORE THE WORKSHOP</a>
     </div>
    </div>
</div>
<div></div>
